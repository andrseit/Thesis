...
public class ScheduleOld {
    ...
    public ScheduleOld(int num_slots, int num_chargers) {
    ...
    public void resetRemainingChargers () {
        for (int s = 0; s < num_slots; s++) {
            remaining_chargers[s] = num_chargers;
        }
    }
    ...
    public void setFullScheduleMap(int[][] full_schedule_map) {
        this.full_schedule_map = full_schedule_map;
    ...
    public void updateFullScheduleMap (EVObject ev, int start, int end, int row) {
        ArrayTransformations t = new ArrayTransformations();
